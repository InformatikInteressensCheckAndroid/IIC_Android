...
var readability = {
    ...
    regexps: {
        ...
        positive:              /article|body|content|entry|hentry|main|page|pagination|post|text|blog|story|iframe/i,
        negative:              /combx|comment|com-|contact|foot|footer|footnote|masthead|media|meta|outbrain|promo|related|scroll|shoutbox|sidebar|sponsor|shopping|tags|tool|widget/i,
        extraneous:            /print|archive|comment|discuss|e[\-]?mail|share|reply|all|login|sign|single/i,
        divToPElements:        /<(a|blockquote|dl|img|ol|p|pre|table|ul)/i,
        replaceBrs:            /(<br[^>]*>[ \n\r\t]*){2,}/gi,
    ...
    grabArticle: function (page) {
        ...
        **/
        ...
        for(var nodeIndex = 0; (node = allElements[nodeIndex]); nodeIndex+=1) {
            ...
            if (node.tagName === "DIV" && !(node.className.indexOf("embeddedContent") > -1)) {
            ...
            } else if(node.className.indexOf("embeddedContent") > -1){
                nodesToScore[nodesToScore.length] = node;
                nodeIndex+=1
            }
        }
